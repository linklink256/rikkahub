 ...
 */
object SecretCrypto {
    private const val KEY_ALIAS = "rikkahub_secrets_v1"
    ...
    fun encrypt(plaintext: String): String {
        ...
        return try {
            ...
            android.util.Log.e(TAG, "encrypt failed; storing plaintext fallback", e)
            plaintext
        }
    }
    ...
    fun decrypt(stored: String): String {
        ...
        return try {
            ...
            android.util.Log.e(TAG, "decrypt failed", e)
            ""
        }
    }
}
